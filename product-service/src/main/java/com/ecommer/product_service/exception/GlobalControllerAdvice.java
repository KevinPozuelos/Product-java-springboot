package com.ecommer.product_service.exception;
...
public class GlobalControllerAdvice {
    ...
    public ProblemDetail handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
        ...
        log.warn("Recurso no encontrado: {}, Message:{}", request.getDescription(false), ex.getMessage());
        ...
        problemDetail.setProperty("Resource", ex.getFieldValue());
    ...
    public ProblemDetail handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST,
                "La validacion falló en uno o mas campos"
        );


        problemDetail.setTitle("Validation Failed");
        problemDetail.setType(URI.create("https://api.ecommerce.com/errors/erro-validation"));
        problemDetail.setProperty("Timestamp", Instant.now());
    ...
    public ProblemDetail handleException(Exception ex, WebRequest request) {
        ...
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.INTERNAL_SERVER_ERROR,
                "A ocurrido inesperado. Por favor, contactar con el administrador."
        );
